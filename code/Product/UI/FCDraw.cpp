...
Long FCDraw::getBlackColor(Long color){
	...
	else if(color == FCCOLORS_LINECOLOR5){
	...
	else if(color == FCCOLORS_UPCOLOR2){
		color = FCColor::argb(100, 255, 82, 82);
	}
...
Long FCDraw::getWhiteColor(Long color){
    if (color > FCCOLORS_USERCOLOR){
        if (color == FCColor_Back){
			color = FCColor::argb(240, 240, 240);
        }
        else if (color == FCColor_Border){
            color = FCColor::argb(0, 0, 0);
        }
	...
	if (color == FCCOLORS_BACKCOLOR){
		...
		color = FCColor::argb(150, 150, 150);
    }
    else if (color == FCCOLORS_BACKCOLOR4){
        color = FCColor::argb(0, 0, 0);
    }
    else if (color == FCCOLORS_BACKCOLOR5){
		color = FCColor::argb(180, 180, 180);
    }
    else if (color == FCCOLORS_BACKCOLOR6){
		color = FCColor::argb(150, 150, 150);
    }
...
void FCDraw::drawText(FCPaint *paint, LPCWSTR strText, Long dwPenColor, FCFont *font, int x, int y){
...
int FCDraw::drawUnderLineNum(FCPaint *paint, double value, int digit, FCFont *font, Long fontColor, bool zeroAsEmpty, int x, int y){
